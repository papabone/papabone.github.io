      ...
      projects : {
        en : [
          ...
          },
          {
            ...
            shortDesc: 'Advertising booklet for music festival',
            type: 'branding',
            infoTipe: 'scrin',
            linkURL: '/',
            bgColor: '#dbdbdb',
        ...
        ru : [
          {
            ...
            shortDesc: 'Приложение для поиска санаториев',
            type: 'web',
            infoTipe: 'scrin',
            linkURL: '/',
            bgColor: '#dbdbdb',
          ...
          },
          {
            ...
            shortDesc: 'Рекламный буклет для музыкального фестиваля ',
            type: 'branding',
            infoTipe: 'scrin',
            linkURL: '/',
            bgColor: '#dbdbdb',
